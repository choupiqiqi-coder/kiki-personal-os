...
import { buildFundRelationshipFacts } from "@/lib/finance/fund-relationships";
...
export async function buildFinanceAnalysisContext(userId:string) {
  ...
  const fundRelationshipFacts=buildFundRelationshipFacts(funds);
