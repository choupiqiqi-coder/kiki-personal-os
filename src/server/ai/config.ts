...
const taskModels:Record<AiProviderId,Record<AiTaskType,string>>={
  openai:{daily_brief:process.env.OPENAI_DAILY_MODEL??"gpt-4o-mini",evening_summary:process.env.OPENAI_DAILY_MODEL??"gpt-4o-mini",viral_material_analysis:process.env.OPENAI_ANALYSIS_MODEL??"gpt-4o",content_review:process.env.OPENAI_ANALYSIS_MODEL??"gpt-4o"},
  anthropic:{daily_brief:process.env.ANTHROPIC_DAILY_MODEL??"claude-haiku-4-5",evening_summary:process.env.ANTHROPIC_DAILY_MODEL??"claude-haiku-4-5",viral_material_analysis:process.env.ANTHROPIC_ANALYSIS_MODEL??"claude-sonnet-4-5",content_review:process.env.ANTHROPIC_ANALYSIS_MODEL??"claude-sonnet-4-5"},
  gemini:{daily_brief:"gemini-2.5-flash",evening_summary:"gemini-2.5-flash",viral_material_analysis:"gemini-2.5-pro",content_review:"gemini-2.5-pro"},
  deepseek:{daily_brief:"deepseek-chat",evening_summary:"deepseek-chat",viral_material_analysis:"deepseek-reasoner",content_review:"deepseek-reasoner"},
  custom_openai_compatible:{daily_brief:process.env.AI_CUSTOM_MODEL??"未配置",evening_summary:process.env.AI_CUSTOM_MODEL??"未配置",viral_material_analysis:process.env.AI_CUSTOM_MODEL??"未配置",content_review:process.env.AI_CUSTOM_MODEL??"未配置"},
};
