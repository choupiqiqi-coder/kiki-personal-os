...
const taskModels:Record<AiProviderId,Record<AiTaskType,string>>={
  ...
  deepseek:{daily_brief:"deepseek-v4-flash",evening_summary:"deepseek-v4-flash",viral_material_analysis:"deepseek-v4-pro",content_review:"deepseek-v4-pro",finance_analysis:process.env.DEEPSEEK_FINANCE_MODEL??"deepseek-v4-flash",market_research:process.env.DEEPSEEK_MARKET_MODEL??process.env.DEEPSEEK_FINANCE_MODEL??"deepseek-v4-flash"},
